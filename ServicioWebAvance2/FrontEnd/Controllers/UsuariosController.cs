...
namespace FrontEnd.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult CreateClient([Bind(Include = "Cod_Usuario,Nombre_Usuario,Pri_Ape_Usuario,Seg_Ape_Usuario,Email_Usuario,Pass_Usuario,Tipo_Usuario")] Usuario usuario)
        {
            if (ModelState.IsValid)
            {
